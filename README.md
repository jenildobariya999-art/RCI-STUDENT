...
| `public/app.js` | Frontend logic for forms, tabs, API calls, Socket.IO, and push subscription. |
...
GitHub Pages cannot run this backend because OTP, encryption, approval, and chat need a Node server. Use GitHub for source code, then deploy to a Node host such as Render, Railway, Fly.io, or a VPS.
